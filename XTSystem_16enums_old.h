...
{ \
  public: \
    ...
    static std::vector<String> GetNames() { static std::vector<String> v; CALL_ONCE_BLOCK{ const Char* args[] = {_T(#T1)}; v = std::vector<String>(args, args + numItems); } return v; }\
    static std::vector<enumType> GetValues() { static std::vector<enumType> v; CALL_ONCE_BLOCK{ const enumType args[] = {T1}; v = std::vector<enumType>(args, args + numItems); } return v; }\
    ENUM_IMPL(NAME,T1) \
}; \
...
{ \
  public: \
    ...
    static std::vector<String> GetNames() { static std::vector<String> v; CALL_ONCE_BLOCK{ const Char* args[] = {_T(#T1),_T(#T2)}; v = std::vector<String>(args, args + numItems); } return v; }\
    static std::vector<enumType> GetValues() { static std::vector<enumType> v; CALL_ONCE_BLOCK{ const enumType args[] = {T1,T2}; v = std::vector<enumType>(args, args + numItems); } return v; }\
    ENUM_IMPL(NAME,T1) \
}; \
...
{ \
  public: \
    ...
    static std::vector<String> GetNames() { static std::vector<String> v; CALL_ONCE_BLOCK{ const Char* args[] = {_T(#T1),_T(#T2),_T(#T3)}; v = std::vector<String>(args, args + numItems); } return v; }\
    static std::vector<enumType> GetValues() { static std::vector<enumType> v; CALL_ONCE_BLOCK{ const enumType args[] = {T1,T2,T3}; v = std::vector<enumType>(args, args + numItems); } return v; }\
    ENUM_IMPL(NAME,T1) \
}; \
...
{ \
  public: \
    ...
    static std::vector<String> GetNames() { static std::vector<String> v; CALL_ONCE_BLOCK{ const Char* args[] = {_T(#T1),_T(#T2),_T(#T3),_T(#T4)}; v = std::vector<String>(args, args + numItems); } return v; }\
    static std::vector<enumType> GetValues() { static std::vector<enumType> v; CALL_ONCE_BLOCK{ const enumType args[] = {T1,T2,T3,T4}; v = std::vector<enumType>(args, args + numItems); } return v; }\
    ENUM_IMPL(NAME,T1) \
}; \
...
{ \
  public: \
    ...
    static std::vector<String> GetNames() { static std::vector<String> v; CALL_ONCE_BLOCK{ const Char* args[] = {_T(#T1),_T(#T2),_T(#T3),_T(#T4),_T(#T5)}; v = std::vector<String>(args, args + numItems); } return v; }\
    static std::vector<enumType> GetValues() { static std::vector<enumType> v; CALL_ONCE_BLOCK{ const enumType args[] = {T1,T2,T3,T4,T5}; v = std::vector<enumType>(args, args + numItems); } return v; }\
    ENUM_IMPL(NAME,T1) \
}; \
...
{ \
  public: \
    ...
    static std::vector<String> GetNames() { static std::vector<String> v; CALL_ONCE_BLOCK{ const Char* args[] = {_T(#T1),_T(#T2),_T(#T3),_T(#T4),_T(#T5),_T(#T6)}; v = std::vector<String>(args, args + numItems); } return v; }\
    static std::vector<enumType> GetValues() { static std::vector<enumType> v; CALL_ONCE_BLOCK{ const enumType args[] = {T1,T2,T3,T4,T5,T6}; v = std::vector<enumType>(args, args + numItems); } return v; }\
    ENUM_IMPL(NAME,T1) \
}; \
...
{ \
  public: \
    ...
    static std::vector<String> GetNames() { static std::vector<String> v; CALL_ONCE_BLOCK{ const Char* args[] = {_T(#T1),_T(#T2),_T(#T3),_T(#T4),_T(#T5),_T(#T6),_T(#T7)}; v = std::vector<String>(args, args + numItems); } return v; }\
    static std::vector<enumType> GetValues() { static std::vector<enumType> v; CALL_ONCE_BLOCK{ const enumType args[] = {T1,T2,T3,T4,T5,T6,T7}; v = std::vector<enumType>(args, args + numItems); } return v; }\
    ENUM_IMPL(NAME,T1) \
}; \
...
{ \
  public: \
    ...
    static std::vector<String> GetNames() { static std::vector<String> v; CALL_ONCE_BLOCK{ const Char* args[] = {_T(#T1),_T(#T2),_T(#T3),_T(#T4),_T(#T5),_T(#T6),_T(#T7),_T(#T8)}; v = std::vector<String>(args, args + numItems); } return v; }\
    static std::vector<enumType> GetValues() { static std::vector<enumType> v; CALL_ONCE_BLOCK{ const enumType args[] = {T1,T2,T3,T4,T5,T6,T7,T8}; v = std::vector<enumType>(args, args + numItems); } return v; }\
    ENUM_IMPL(NAME,T1) \
}; \
...
{ \
  public: \
    ...
    static std::vector<String> GetNames() { static std::vector<String> v; CALL_ONCE_BLOCK{ const Char* args[] = {_T(#T1),_T(#T2),_T(#T3),_T(#T4),_T(#T5),_T(#T6),_T(#T7),_T(#T8),_T(#T9)}; v = std::vector<String>(args, args + numItems); } return v; }\
    static std::vector<enumType> GetValues() { static std::vector<enumType> v; CALL_ONCE_BLOCK{ const enumType args[] = {T1,T2,T3,T4,T5,T6,T7,T8,T9}; v = std::vector<enumType>(args, args + numItems); } return v; }\
    ENUM_IMPL(NAME,T1) \
}; \
...
{ \
  public: \
    ...
    static std::vector<String> GetNames() { static std::vector<String> v; CALL_ONCE_BLOCK{ const Char* args[] = {_T(#T1),_T(#T2),_T(#T3),_T(#T4),_T(#T5),_T(#T6),_T(#T7),_T(#T8),_T(#T9),_T(#T10)}; v = std::vector<String>(args, args + numItems); } return v; }\
    static std::vector<enumType> GetValues() { static std::vector<enumType> v; CALL_ONCE_BLOCK{ const enumType args[] = {T1,T2,T3,T4,T5,T6,T7,T8,T9,T10}; v = std::vector<enumType>(args, args + numItems); } return v; }\
    ENUM_IMPL(NAME,T1) \
}; \
